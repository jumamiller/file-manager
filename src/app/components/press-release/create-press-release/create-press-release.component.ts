...
@Component({
  selector: 'app-create-press-release',
  templateUrl: './create-press-release.component.html',
  styleUrls: ['./create-press-release.component.css']
})
export class CreatePressReleaseComponent implements OnInit {
  ...
  onPressSubmit(){
    ...
    this.apiService.createPressRelease(pressRelease)
      .subscribe((res)=>{
        if(res){
